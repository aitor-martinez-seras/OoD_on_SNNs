...
from SCP.models.fc import FCSNN1, FCSNN2, FCSNN3, FCSNN4, FCSNN5, FCSNN6, FCSNN7, FC8, FCSNN9
from SCP.models.conv import ConvSNN1, ConvSNN2, ConvSNN3, ConvSNN5, ConvSNN4, ConvSNN6, LIFConvNet, ConvSNN9, \
    ...
    ConvSNN18, ConvSNN19_max_pooling, ConvSNN20, ConvSNN21
...
def decoder_seq_state(x):
    print(x[0], x[1])
    print(f'Classification: {(x.count_nonzero() / x.nelement()) * 100:.3f}%')

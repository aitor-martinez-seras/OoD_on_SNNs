...
class FCSNN9(torch.nn.Module):
    """
    2 linear layers with 400-100
    """
    def __init__(self, input_features, hidden_features, output_features, dt=0.001):
        super().__init__()
        ...
        # Linear layers
        self.fc1 = torch.nn.Linear(input_features, 400, bias=False)
        self.fc2 = torch.nn.Linear(400, hidden_features, bias=False)  # The idea is to use 128
        self.fc_out = torch.nn.Linear(hidden_features, output_features, bias=False)
...
class FCSNN10(torch.nn.Module):
    ...
    def __init__(self, input_features, hidden_features, output_features, dt=0.001):
        ...
        # Linear layers
        self.fc1 = norse.torch.Lift(torch.nn.Linear(input_features, 400, bias=False))
        self.fc2 = norse.torch.Lift(torch.nn.Linear(400, hidden_features, bias=False))  # The idea is to use 128
        self.fc_out = norse.torch.Lift(torch.nn.Linear(hidden_features, output_features, bias=False))
